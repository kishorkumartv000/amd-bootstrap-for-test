...
EXTRACT_BOOTSTRAP_ONLY=true

# Define your repositories in order of PRIORITY
REPOS=(
    "https://github.com/kishorkumartv000/amd-bootstrap-for-test"
    "https://zinxamurafaridadunaca053-admin@bitbucket.org/zinxamurafaridadunaca0539gyfr4607/amd-bootstrap-for-test.git"
    "https://gitlab.com/bootstrap-main-group-000/amd-bootstrap-for-test.git"
)

# Fixed configuration
CLONE_TARGET_DIR="/tmp/repo_cache"
BOOTSTRAP_WORKDIR="/usr/src/app"
...
prepare_workspace() {
    ...
    chown -R "$(whoami):$(whoami)" "$BOOTSTRAP_WORKDIR"
